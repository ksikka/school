function [bestk,bestpp,bestmu,bestcov,dl,countf] = ...
    ml_mixtures4(y,kmin,kmax,regularize,th,covoption)
%ML_MIXTURE4 This a function modeified from the MIXTURE4 function written
%   by Mario Figueiredo (http://www.lx.it.pt/~mtf/mixturecode.zip). 
%
% Syntax:
% [bestk,bestpp,bestmu,bestcov,dl,countf] =
%   mixtures3(y,kmin,kmax,regularize,th,covoption) 
%
% Inputs:
%
...
%   This function is included with the permission of Dr. Mario Figueiredo.
...
%        plot(plotgrid,bestpp(comp)*uninorm(plotgrid,bestmu(comp), ...
%            bestcov(comp)),'k','LineWidth',2)
%    end
% %    plot(plotgrid,mix,'Color','red','LineWidth',3);

...
% Revised December 20, 2010 by R.F. Murphy to add SLF37
% Revised August 28, 2011 by R.F. Murphy to add SLF38
%
...
case 'SLF37'
    featidx = [1:112];
    % force the definition of gray levels and subtractions method for this feature set
    tgray = 256;
    bgsub = 'nobgsub';
case 'SLF38'
    featidx = [1:114];
